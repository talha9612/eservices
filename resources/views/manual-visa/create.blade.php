        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <form action="{{ route('manual-visa.store') }}" id="create-visa-form" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Upload Visa: <span class="error">*</span></label>
              ...
              <div class="card-footer">
                <button class="btn btn-success" id="btn-upload-visa"><i class="fas fa-upload"></i> Upload</button>
                <a class="btn btn-danger" href="{{ route('manual-visa.index') }}">Back</a>
              </div>
            </div>
            <!-- /.card -->
          </div>
