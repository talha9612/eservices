		...
		<div class="col-md-6 mt-40">
			<div class="card">
				<div class="card-header">
					...
					@endif
					<h2 class="text-center">Know The Visa Status</h2>
					<form action="{{ route('visa.pdf') }}" method="POST">
						@csrf
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<button type="submit" class="btn btn-success" style="background-color: #218838; color: #fff; width: 100%;"><i class="fas fa-search"></i> &nbsp; Search</button>
								</div>
							</div>
						</div>
					</form>
